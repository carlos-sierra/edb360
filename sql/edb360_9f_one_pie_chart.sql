...
SELECT TO_CHAR(SYSDATE, '&&edb360_date_format.')||' , '||
       ...
       '&&row_num., &&section_id., &&main_table., &&edb360_prev_sql_id., -1, &&title_no_spaces., html , &&one_spool_filename._pie_chart.html'
  FROM DUAL
/
SPO OFF;
SET HEA ON;
...
-- zip
HOS zip -m &&edb360_main_filename._&&edb360_file_time. &&one_spool_filename._pie_chart.html >> &&edb360_log3..txt
