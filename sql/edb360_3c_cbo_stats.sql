...
SELECT /*+ &&top_level_hints. */
       ...
       &&skip_10g.SUM(DECODE(flash_cache, ''KEEP'', 1, 0)) keep_flash_cache,
       &&skip_10g.SUM(DECODE(cell_flash_cache, ''KEEP'', 1, 0)) keep_cell_flash_cache,
       &&skip_10g.SUM(DECODE(result_cache, ''FORCE'', 1, 0)) result_cache_force,
       ...
       &&skip_10g.SUM(DECODE(read_only, ''YES'', 1, 0)) read_only,
