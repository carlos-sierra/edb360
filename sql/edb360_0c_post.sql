...
HOS &&skip_extras. zip -m &&edb360_zip_filename. listener_log.zip >> &&edb360_log3..txt
HOS rm listener_log_driver.sql

-- zip 
HOS zip -m &&edb360_zip_filename. &&common_edb360_prefix._query.sql >> &&edb360_log3..txt
...
HOS &&skip_extras. zip -m &&edb360_zip_filename. 00006_&&common_edb360_prefix._alert_*.log >> &&edb360_log3..txt
HOS &&skip_extras. zip -j 00007_&&common_edb360_prefix._opatch $ORACLE_HOME/cfgtoollogs/opatch/opatch* >> &&edb360_log3..txt
HOS &&skip_extras. zip -m &&edb360_zip_filename. 00007_&&common_edb360_prefix._opatch.zip >> &&edb360_log3..txt
HOS zip -m &&edb360_zip_filename. &&edb360_log2..txt >> &&edb360_log3..txt
--HOS zip -m &&edb360_zip_filename. awrinfo.txt >> &&edb360_log3..txt
HOS zip -m &&edb360_zip_filename. &&edb360_tkprof._sort.txt >> &&edb360_log3..txt
HOS zip -m &&edb360_zip_filename. &&edb360_log..txt >> &&edb360_log3..txt
HOS zip -m &&edb360_zip_filename. &&edb360_main_report..html >> &&edb360_log3..txt
