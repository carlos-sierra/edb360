DEF edb360_vYYNN = 'v1613';
DEF edb360_vrsn = '&&edb360_vYYNN. (2016-07-07)';
...
-- zip esp
HOS zip -m esp_output_&&esp_host_name_short._&&database_name_short._&&esp_collection_yyyymmdd..zip cpuinfo_model_name_&&esp_host_name_short._&&esp_collection_yyyymmdd..txt >> &&edb360_log3..txt
HOS zip -m esp_output_&&esp_host_name_short._&&database_name_short._&&esp_collection_yyyymmdd..zip escp_&&esp_host_name_short._&&esp_collection_yyyymmdd..csv >> &&edb360_log3..txt
HOS zip -m esp_output_&&esp_host_name_short._&&database_name_short._&&esp_collection_yyyymmdd..zip esp_requirements_*_&&esp_host_name_short._&&esp_collection_yyyymmdd.*.csv >> &&edb360_log3..txt
HOS zip -m esp_output_&&esp_host_name_short._&&database_name_short._&&esp_collection_yyyymmdd..zip res_requirements_*_&&esp_host_name_short._&&esp_collection_yyyymmdd.*.txt >> &&edb360_log3..txt
-- removes duplicate zip generated by esp_master
HOS zip -m esp_recycle_bin.zip esp_output_&&esp_host_name_short._&&esp_collection_yyyymmdd..zip
HOS rm esp_recycle_bin.zip

-- zip esp into main
HOS zip -m &&edb360_main_filename._&&edb360_file_time. esp_output_&&esp_host_name_short._&&database_name_short._&&esp_collection_yyyymmdd..zip >> &&edb360_log3..txt
-- zip other files
